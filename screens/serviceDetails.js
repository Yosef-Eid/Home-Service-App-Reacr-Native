...
export default function ServiceDetails() {
  ...
  const handleBookNow = async () => {
    ...
    try {
      ...
      if (existingBookings) bookings = JSON.parse(existingBookings);
  ...
  return (
    <Animated.View
      ...
      className="w-[90%] flex-1 rounded-2xl bg-[#F9F9F9]">
      <ScrollView>
        <ImageBackground style={{ paddingBottom: 100, height: 350, zIndex: 1 }} source={service.img} className="pb- justify-between p-4">
          <InoIcon name="arrow-back" size={24} color="white" style={{ width: 40, height: 40 }} onPress={() => navigation.goBack()} />
          <View className="gap-4">
            <View
              className="flex-row items-center rounded-full "
              style={{ width: 82, padding: 4, gap: 4, backgroundColor: '#FB9450' }}>
            ...
            <View>
              <Text className="text-4xl font-bold text-white">{service.name}</Text>
          ...
          <View
            ...
            <View
              ...
              <View className="flex-row items-center gap-3">
                <View className="h-4 w-1 bg-[#CABDFF]" />
            ...
            <View
              ...
              <View className="flex-row items-center gap-3">
                <View className="h-4 w-1 bg-[#CABDFF]" />
                <Text className="text-xl font-semibold">Type of Property</Text>
              </View>

              <View className="flex-row justify-between">
                <TouchableOpacity
                  className="items-center gap-3"
                  onPress={() => setPropertyType('Home')}>
                  <View
                    style={{
                      width: 64,
                      height: 64,
                    ...
                    <View>
                      <Feather
                        name="home"
                        size={24}
                        color={propertyType === 'Home' ? '#6759FF' : '#B3B3B3'}
                      />
                    </View>
                  </View>
                  ...
                  <View
                    ...
                    <View>
                      <Building
                        name="building"
                        size={24}
                        color={propertyType === 'Office' ? '#6759FF' : '#B3B3B3'}
                      />
                    </View>
                  </View>
                  <Text style={{ color: propertyType === 'Office' ? '#6759FF' : '#000' }}>
                    Office
                  </Text>
                </TouchableOpacity>
                  ...
                  <View
                    ...
                    <View>
                      <Ionicons
                        ...
                        size={24}
                        color={propertyType === 'Vila' ? '#6759FF' : '#B3B3B3'}
                      />
                    </View>
                  </View>
            ...
            <View
              ...
              <View className="flex-row items-center justify-between">
                <Text className="mb-4 text-lg font-bold">Number of Units</Text>
                <View className="flex-row items-center gap-4">
                  ...
                  <Text className="text-xl font-semibold text-[#363F4F]">{units1}</Text>
                  <Pressable
                    onPress={increase1}
                    style={{
                      width: 40,
              ...
              <View className="flex-row items-center justify-between">
                <Text className="mb-4 text-lg font-bold">Number of Bedrooms</Text>
                <View className="flex-row items-center gap-4">
                  <Pressable
                    onPress={decrease2}
                    style={{
                  ...
                  <Text className="text-xl font-semibold text-[#363F4F]">{units2}</Text>
                  <Pressable
                    onPress={increase2}
                    style={{
                      width: 40,
            ...
            <View
              style={{
                width: '100%',
                height: 230,
                display: !showBillDetails ? 'none' : 'flex',
                position: 'absolute',
                bottom: 120,
                padding: 16,
                backgroundColor: 'white',
                boxShadow: '0px 0px 200px 0px rgba(0, 0, 0, 0.7)',
                borderRadius: 16,
                gap: 16,
              }}>
              <View className="flex-row items-center gap-3">
                <View className="h-4 w-1 bg-[#CABDFF]" />
                <Text className="text-xl font-semibold">Select your Date & Time?</Text>
              </View>
            ...
            <View
              ...
              <TouchableOpacity
                title="Go to Details"
                className="h-[48px] w-full items-center justify-center rounded-xl bg-[#6759FF] active:bg-purple-600"
